...
function HomePage() {
    ...
    return (
        <section>
            ...
            <img className="img-align" src="./images/group_of_people.jpg" width="250" height="250" alt="Guidr Logo"></img>
            ...
            <br />
            <img className="img-align" src="./images/people_doing_things.jpg" width="250" height="250" alt="Guidr Logo"></img>
